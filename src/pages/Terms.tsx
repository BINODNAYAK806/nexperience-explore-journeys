    ...
    <div className="min-h-screen bg-background py-16">
      <div className="container-custom max-w-4xl">
        ...
        <div className="bg-card rounded-lg shadow-lg p-8 md:p-12">
          ...
          <p className="text-muted-foreground mb-8">Last updated on 27-11-2025 23:17:17</p>

          <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
            <p>
              These Terms and Conditions, along with privacy policy or other terms ("Terms") constitute a binding
              agreement by and between Nexyatra, ("Website Owner" or "we" or "us" or "our") and you ("you" or
            ...
            <ul className="list-disc pl-6 space-y-4">
              ...
              <li>
                ...
                jurisdiction of the courts in Sagrampura Putli, Gujarat.
              </li>
